...
profile_id = os.getenv('PROFILE_ID')                     # Change to profile ID
...
def get_statement(one_time_token, signature):
    ...
    url =  (
        base_url + "/v3/profiles/"+profile_id+"/borderless-accounts/"+account_id+"/statement.json?currency=AUD&intervalStart=2023-11-04T00%3A00%3A00.000Z&intervalEnd=2023-11-04T23%3A59%3A59.999Z"
    )
    headers = {
